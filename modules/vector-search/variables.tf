...
variable "region" {
  type        = string
  description = "The region of the index endpoint."
}
...
variable "index_endpoint_display_name" {
  type        = string
  description = "The display name of the Index Endpoint. The name can be up to 128 characters long and can consist of any UTF-8 characters."
}
