...
var (
	...
	firewallName           = "test-allow-egress-alloydb"
...
*/
func TestCreateAlloyDBFirewallRule(t *testing.T) {
	var (
	...
	want := firewallName
	firewallRuleOutputValue := terraform.OutputJson(t, terraformOptions, "alloydb_firewall_rules")
