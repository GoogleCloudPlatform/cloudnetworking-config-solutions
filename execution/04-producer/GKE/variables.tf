...
variable "config_folder_path" {
  description = "Location of YAML files holding GKE configuration values."
  type        = string
  default     = "../../../configuration/producer/GKE/config"
}